...
class SegmentationDrawPipeline(SegmentationEffectPipeline):
    def __init__(self) -> None:
        super().__init__()

        self.widget = SegmentationDrawWidget()
