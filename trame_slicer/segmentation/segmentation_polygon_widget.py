...
class SegmentationPolygonWidget:
    """
...
class SegmentationPolygonPipeline(SegmentationEffectPipeline, ABC):
    def __init__(self) -> None:
        super().__init__()

        self.widget = SegmentationPolygonWidget()
        ...
        self._supported_events: dict[int, Callable] = {
            ...
            int(vtkCommand.RightButtonReleaseEvent): self._RightButtonReleased,
        }
