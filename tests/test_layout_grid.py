...
def test_layout_component_can_display_server_configured_templates(a_server, unused_tcp_port):
...
def test_layout_component_is_compatible_with_size(a_server, unused_tcp_port):
    with ViewLayout(a_server, "red_view"):
        Div(style="background-color: red;", classes="fill-height")
