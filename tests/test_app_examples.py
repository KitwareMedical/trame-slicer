...
from examples.minimal_trame_slicer_app import MinimalTrameSlicerApp
from examples.segmentation_app import SegmentationApp


@pytest.mark.parametrize("example_cls", [MedicalViewerApp, SegmentationApp, MinimalTrameSlicerApp])
@pytest.mark.asyncio
